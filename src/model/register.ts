...
export const registerFormSchema = z.object({
    firstname: z.string({ required_error: 'enter your firstname' }).min(4, { message: "firstname should not be less than 4 words" }),
    middlename: z.string().optional(),
    lastname: z.string({ required_error: 'enter your lastname' }).min(4, { message: "lastname should not be less than 4 words" }),
